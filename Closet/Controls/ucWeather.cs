...
namespace Closet.Controls
{
	public partial class ucWeather : UserControl
	{
		...
		public void SetValue(int fk_weatherId)
		{
			CheckBox[] controls = new CheckBox[] {checkBox1, checkBox2, checkBox3 };
			// 先將所有checkbox取消勾選
			foreach (CheckBox item in controls)
			...
			else if (fk_weatherId == 2)
			{
				checkBox1.Checked = true;
				checkBox2.Checked = false;
				checkBox3.Checked = false;
			}
			else if (fk_weatherId == 3)
			{
				checkBox1.Checked = true;
				checkBox2.Checked = false;
				checkBox3.Checked = true;
			}
			else if (fk_weatherId == 4)
			{
				checkBox1.Checked = true;
				checkBox2.Checked = true;
				checkBox3.Checked = false;
			}
			else if (fk_weatherId == 5)
			{
				checkBox1.Checked = false;
				checkBox2.Checked = true;
				checkBox3.Checked = true;
			}
			else if (fk_weatherId == 6)
			{
				checkBox1.Checked = false;
				checkBox2.Checked = true;
				checkBox3.Checked = false;
			}
			else if (fk_weatherId == 7)
			{
				checkBox1.Checked = false;
				checkBox2.Checked = false;
				checkBox3.Checked = true;
			}
			else if (fk_weatherId == 8)
			{
				checkBox1.Checked = false;
				checkBox2.Checked = false;
				checkBox3.Checked = false;
